...
function Signup() {
  ...
  <div className="modal-box  dark:bg-slate-900 dark:text-white">
    ...
    <div className='mt-4 space-y-2'>
      <span>Name</span><br/>
      <input type='text' placeholder='Enter your Name..' className='w-80 px-3 border rounded-md outline-none py-1 dark:bg-slate-900 dark:text-white'
    ...
    <div className='flex justify-around mt-4'>
      <button className='bg-pink-500 text-white px-4 py-2 rounded-md hover:bg-pink-700 duration-200 '>Sign up</button>
